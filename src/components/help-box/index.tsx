...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Healthcare Administrator'];
  const customerRoles: string[] = [];
  const tenantRoles: string[] = ['Nephrologist'];
  const addOns: string[] = ['notifications'];
  const applicationName = `Acute Kidney Injury`;
  const tenantName = `Hospital`;
